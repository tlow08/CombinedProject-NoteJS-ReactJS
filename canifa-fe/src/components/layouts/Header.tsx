      ...
      <section className="container max-w-screen-2xl my-3 grid grid-cols-5 gap-8">
        ...
        <div className="col-span-4 grid grid-cols-7">
          <div className="col-span-4  flex items-center justify-center">
            ...
            >
              <input
                className="border-r-0 border py-2 pl-3 outline-none placeholder:text-[13px] placeholder:text-gray-500 rounded-md w-[400px]"
                type="text"
          ...
          <div className="col-span-1 flex items-center justify-end">
            ...
            <div className="mx-2">
              ...
              <p className="text-[15px] font-semibold text-red-700">1</p>
            </div>
          </div>
        </div>
      </section>
      <nav className="bg-red-700">
        <div className="container max-w-screen-2xl text-xl font-semibold text-white flex justify-between py-2 px-5 ">
          <ul className="flex items-center gap-8 ">
            <li>
              <Link to="/">
                <i className="bi bi-house-door-fill hover:text-yellow-400"></i>
              </Link>
            </li>
            <li>
          ...
          <div className="flex">
            {user ? (
              <div className="flex gap-2 text-base text-yellow-400 items-center">
                <p>Chào mừng {user?.email} đến với siêu thị bếp Thanh Hiền</p>
              ...
              <Link to="/login">
                <div className="flex">
                  <i className="bi bi-person-fill hover:text-yellow-400"></i>
                </div>
              </Link>
            )}
          </div>
